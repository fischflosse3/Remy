...
(function initRemySideChat() {
  ...
  style.textContent = `
    ...
    .remy-action-menu{position:absolute;right:6px;bottom:50px;width:170px;height:150px;pointer-events:none}.remy-action-menu.hidden{display:none}.remy-action-bubble{position:absolute;width:66px;height:66px;border:0;border-radius:999px;font-size:10.5px;line-height:1.05;font-weight:900;cursor:pointer;box-shadow:0 14px 34px rgba(31,41,55,.20);pointer-events:auto;display:grid;place-items:center;text-align:center}.remy-action-local{right:6px;bottom:84px;background:#ede9fe;color:#5b21b6}.remy-action-ignore{right:66px;bottom:52px;background:#fff7ed;color:#9a3412}.remy-action-public{right:96px;bottom:6px;background:#ecfeff;color:#0e7490}.remy-action-bubble:hover{transform:translateY(-2px) scale(1.04)}
