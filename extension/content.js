...
(function initRemySideChat() {
  ...
  style.textContent = `
    ...
    .remy-action-menu{position:absolute;right:6px;bottom:76px;width:152px;height:152px;pointer-events:none}.remy-action-menu.hidden{display:none}.remy-action-bubble{position:absolute;width:66px;height:66px;border:0;border-radius:999px;font-size:10.5px;line-height:1.05;font-weight:900;cursor:pointer;box-shadow:0 14px 34px rgba(31,41,55,.20);pointer-events:auto;display:grid;place-items:center;text-align:center}.remy-action-local{right:0;bottom:82px;background:#ede9fe;color:#5b21b6}.remy-action-ignore{right:58px;bottom:58px;background:#fff7ed;color:#9a3412}.remy-action-public{right:82px;bottom:0;background:#ecfeff;color:#0e7490}.remy-action-bubble:hover{transform:translateY(-2px) scale(1.04)}
