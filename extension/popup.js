...
function renderMode(){ const pub=state.mode==='public'; $('modeLocal').classList.toggle('active',!pub); $('modePublic').classList.toggle('active',pub); $('modeHelp').textContent=pub?'Öffentlich nutzt allgemeines KI-Wissen. Keine privaten Daten eingeben.':'Lokal nutzt deine gespeicherten Browser-Erinnerungen.'; }
